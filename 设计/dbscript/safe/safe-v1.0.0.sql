...
(
   ...
   enterprise_website   varchar(100) not null default '' comment '企业网址',
   ...
   enterprise_scale     int(1) not null default '' comment '企业规模 1-1-50人, 2-50-150人, 3-150-500人, 4-500-1000人, 5-1000人以上',
...
(
   ...
   parent_org_name      varchar(100) not null default '' comment '机构父名称',
   org_name             varchar(100) not null default '' comment '机构名称',
   org_alias            varchar(100) not null default '' comment '机构别名',
...
(
   ...
   item_status          int(1) not null default 1 comment '字典子项状态 0-无效, 1-有效',
   is_delete            int(1) not null default 0 comment '删除标识 0-未删除, 1-已删除',
   remark               varchar(200) not null default '' comment '备注',
   sort                 int not null default 1 comment '排序号',
   created              varchar(50) not null default '' comment '创建人',
